 ...
 *
 * 380 - https://leetcode.com/problems/insert-delete-getrandom-o1/description/?envType=study-plan-v2&envId=top-interview-150
 */
public class InsertDeleteGetRandomO1 {
    ...
    public int getRandom() {
        int rand = ThreadLocalRandom.current().nextInt(1, count + 1);
